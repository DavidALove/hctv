...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="contact-section relative py-[140px] px-12 bg-black text-center overflow-hidden"
    >
      <div className="relative max-w-[800px] mx-auto">
        ...
        <p className="text-[1rem] text-cream-dim leading-[1.8] mb-12 max-w-[540px] mx-auto">
        ...
        <div className="flex justify-center items-center gap-6 mb-8">
          <a
            ...
            className="btn-primary inline-flex items-center gap-2 bg-blue text-black px-8 py-3.5 text-[0.75rem] font-semibold tracking-[0.14em] uppercase no-underline transition-all duration-200"
          >
        ...
        {submitted ? (
          ...
          <form
            ...
            className="flex max-w-[540px] mx-auto border border-border gap-px"
          ...
          >
            <input
              ...
              required
              className="flex-1 px-5 py-3.5 text-[0.85rem] text-cream outline-none border-none"
              style={{
